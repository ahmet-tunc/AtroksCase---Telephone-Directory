namespace Core.Constants
{
    public static class Message
    {
        ...
        public static string ListedRecord = "İlgili kayıt başarıyla listelendi.";
        public static string ListedRecords = "İlgili kayıtlar başarıyla listelendi.";
        ...
        public static string AddedFailedForExistingRecord = "İlgili konuma ait aynı kullanıcı zaten var. Lütfen farklı bir konumla tekrar deneyiniz.";
